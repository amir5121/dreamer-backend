...
RUN apk add --no-cache  postgresql-dev jpeg-dev libmagic libxslt-dev g++ jpeg-dev
RUN apk add --no-cache --virtual .build-deps build-base libffi-dev zlib-dev libxml2 freetype-dev
