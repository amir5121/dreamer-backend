...
class ListModelMixin:
    ...
    def list(self, request, *args, **kwargs):
        ...
        return DreamerResponse(data=serializer.data).toJSONResponse()
...
class CreateModelMixin:
    ...
    def create(self, request, *args, **kwargs):
        ...
        return DreamerResponse(code=status.HTTP_201_CREATED, data=serializer.data, headers=headers).toJSONResponse()
